...
async def play(_, message: Message):
    ...
    if message.chat.id in DISABLED_GROUPS:
        await message.reply(
            " __**- المطور ضايج وطفة البوت راسلة وكله شبيك ! **__"
        )
        return
    ...
    if audio:
        ...
        title = "Wa"
        thumb_name = "https://telegra.ph/file/82681721aaaa05789dae2.jpg"
    ...
    if await is_active_chat(message.chat.id):
        ...
        await message.reply_photo(
            photo="https://telegra.ph/file/82681721aaaa05789dae2.jpg",
    ...
    os.remove("https://telegra.ph/file/82681721aaaa05789dae2.jpg")
